...
%%%%%%%%%%%%%%
    ...
    \adi{
how the new batteries were obtained, tested and recharged,
}
    ...
    Vesa attempted to revive this battery through desulphation, where a higher-than-recommended voltage (in this case, ) is applied to the battery to force current through the hardened sulphate layers and dissolve them. 
