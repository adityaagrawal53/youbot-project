...
%%%%%%%%%%%%%%
    ...
    learning goals
    technical goals: deployment, measurement of the quality of the odometry 
    ...
    expansion of the goals
    setup of system

    software, metholodogies
