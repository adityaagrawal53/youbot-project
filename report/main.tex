...
$   roscore 
    ...
    \paragraph{Interface Naming Note:} Not all Linux distributions name Ethernet interfaces as \code{eth0}, and instead may use interfaces named \code{eth1}, \code{enp2s0}, etc. To identify the correct interface, use the following command:
