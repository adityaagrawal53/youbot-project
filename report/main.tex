...
%%%%%%%%%%%%%%
    ...
    \begin{figure}[ht]
        ...
        %/flushleft
        %/flushright
        \includegraphics[width=0.5\linewidth]{images/sec2/box2.jpg}
    ...
    \notes{add image of the battery here.}
